...
def lemmatize_text(text: str) -> str:
    ...
    # TODO
    lemma = nlp(text)
    lemma = " ".join([token.lemma_ for token in lemma])
...
def remove_special_chars(text: str, remove_digits: Optional[bool] = False) -> str:
    ...
    """
    # TODO
    attribute = "isalpha" if remove_digits else "isalnum"
    clean = " ".join(
        ["".join([letter for letter in word if getattr(letter, attribute)()])
...
def remove_stopwords(
    ...
    return " ".join([
        ...
        if word not in stopwords and word.islower()])
